...
if($db->connect_errno !=0){
    ...
    $update_hits = "UPDATE rates SET hits = '$new_hits' where id='$id' and typ='Enduro'";
    ...
    $update_suma = "UPDATE rates SET suma = '$new_suma' where id = '$id' and typ='Enduro'";
    ...
    $update_rating = "UPDATE rates SET oceny = '$new_rating' WHERE id='$id' and typ='Enduro'";
